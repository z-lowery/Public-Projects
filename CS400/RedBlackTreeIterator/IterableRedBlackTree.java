...
public class IterableRedBlackTree<T extends Comparable<T>> 
    ...
    public void IterableRBTTest01() {
        ...
        Assert.assertTrue(result.equals("6 8 11 13 15 17 22 "));
     ...
     * This test tests the following scenarios:
     *      - A string tree
     *      - A tree with a UNspecified start(min) and an UNspecified end point(max)
     */
    @Test
    public void IterableRBTTest03() {
        RedBlackTree<String> tree = new RedBlackTree<>(); // initializes new tree
        tree.insert("blue");
        tree.insert("green");
        tree.insert("green");
        tree.insert("yellow");
        ...
        RBTIterator<String> iterator = new RBTIterator<>(tree.root, null, null);

        String result = getResult((Iterator<T>) iterator); // stores values between min and max from the built stack
